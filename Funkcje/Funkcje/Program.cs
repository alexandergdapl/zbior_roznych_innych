...
namespace Funkcje
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Rekurencja:{0}\nIteracja:{1}", SilniaRekurencyjnie(n), SilniaIteracyjnie(n));
            //sposob w jaki można wywołać utworzone przez nas metody liczące na dwa sposoby silnie
           


            int zmienna=Fibonacci(20);
            //sposob wywołania funkcji, kiedy chcemy jej wynik przypisać zmiennej,
            //zamiast 2 można wstawiż zmienną
